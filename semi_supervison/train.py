...
def loss_function(w1,w2,nn_inputs, outputs, targets):
...
for i in range(total_iterations):
    ...
    train_dataset = TensorDataset(input_data_valid, label_data_valid)
    ...
    for epoch in range(init_epoch,int(init_epoch+num_epochs)):
        ...
        for inputs, targets in train_loader:
            ...
            # Calculate losses
            loss1, loss2 = loss_function(w1_tensor,w2_tensor,inputs, outputs, targets.to(device))
