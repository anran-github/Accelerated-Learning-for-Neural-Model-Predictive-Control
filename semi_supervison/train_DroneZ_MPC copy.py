...
# convert to tensor
X_train_tensor_opt = torch.Tensor(data_opt_set)
y_train_tensor_opt = torch.Tensor(label_opt_set)

train_dataset_opt = TensorDataset(X_train_tensor_opt, y_train_tensor_opt)
