...
def Heater_onnx_model():
    ...
    model.load_state_dict(torch.load('Heater_Results/uniform_S10_constant_Iter20_Epoch10 copy.pth'))
    ...
    torch.onnx.export(model,               # model being run
                    ...
                    "Heater_Results/uniform_S10_constant_Iter20_Epoch10.onnx",   # where to save the model (can be a file or file-like object)
